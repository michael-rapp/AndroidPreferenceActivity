 ...
 * visualization of preference headers, must implement.
 * 
 * @author Michael Rapp
 *
 * @since 1.0.0
...
public interface PreferenceHeaderDecorator {
	...
	/**
	 * The method, which is invoked, when the decorator is applied to modify the
	 * visualization of a specific preference header.
	 * 
	 * @param position
	 ...
	 *            not be null
	 */
	void onApplyDecorator(int position, PreferenceHeader preferenceHeader,
